...
int main(int argc, char** argv)
{
   ...
   private_nh.param("file_directory", file_directory, std::string("/media/tx/NJBL/TX/liosam_map/"));//此处需要修改为自己pcd文件的路径
   ROS_INFO("*** file_directory = %s ***\n", file_directory.c_str());
 
 
   private_nh.param("file_name", file_name, std::string("GlobalMap_re"));//此处"pcd_name"需要修改为自己的pcd文件名，无需.pcd
